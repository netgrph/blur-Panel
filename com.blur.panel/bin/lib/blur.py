...
# vspipe outputs via Y4M which only supports YUV/Gray without alpha.
# If the input was RGB (e.g. AVI lossless from AE), convert before output.
if video.format.color_family not in (vs.YUV, vs.GRAY):
    _matrix_s = "601" if video.width < 1280 else "709"
